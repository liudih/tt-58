...
public class OrderItem implements Serializable {
	...
	public String getUnitPriceStr(String currency) {
		return Utils.money(this.unitPrice, currency);
	}
	...
	public String getTotalPriceStr(String currency) {
		return Utils.money(this.totalPrice, currency);
	}
