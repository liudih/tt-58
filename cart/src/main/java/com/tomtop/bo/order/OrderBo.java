...
public class OrderBo {
	...
	// ~ 插入的时候有用
	private String ip;
	private OrderAddressBo address;
	private List<OrderDetailBo> details;
	private List<OrderStatusBo> historyStatus;
	...
	public OrderAddressBo getAddress() {
		return address;
	}

	public void setAddress(OrderAddressBo address) {
	...
	public List<OrderStatusBo> getHistoryStatus() {
		return historyStatus;
	}

	public void setHistoryStatus(List<OrderStatusBo> historyStatus) {
