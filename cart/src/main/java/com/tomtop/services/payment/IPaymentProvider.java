...
public interface IPaymentProvider {
	 ...
	 * @return
	 */
	String getDescription(PaymentContext context);
	 ...
	 * @return
	 */
	String getInstruction(PaymentContext context);
	 ...
	 * @return
	 */
	Map<String,String> getDoPaymentParas(PaymentContext context);
	 ...
	 * @return
	 */
	boolean validForm(PlaceOrderForm from);
