...
import com.tomtop.bo.order.OrderDetailBo;
import com.tomtop.bo.order.OrderStatusBo;
...
import com.tomtop.mappers.order.OrderAlterHistoryMapper;
...
public class OrderUpdateService implements IOrderUpdateService {
	 ...
	 * 
	 * @see
	 * services.order.IOrderUpdateService#updateShowValidEmail(java.lang.Integer
	 ...
	 * (non-Javadoc)
	 * 
	 * @see services.order.IOrderUpdateService#updateShow(java.lang.Integer,
	 * java.util.List)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * services.order.IOrderUpdateService#insert(com.website.dto.order.Order[])
	 */
	@Override
	public String insert(OrderBo[] orders) {
		String result = "";
		...
		List<OrderStatusHistory> historyList = Lists.newArrayList();
		for (OrderBo order : orders) {
			...
			List<OrderStatusHistory> historyList1 = this.insertHistoryStatus(
					order.getHistoryStatus(), order.getId());
	...
	private List<OrderDetail> insertDetail(List<OrderDetailBo> orderdetails) {
	...
	private List<OrderStatusHistory> insertHistoryStatus(
			List<OrderStatusBo> orderhistoryStatus, int orderid) {
		if (orderhistoryStatus == null)
			return null;
		List<OrderStatusHistory> orders = Lists.transform(orderhistoryStatus,
				obj -> {
	 ...
	 * 
	 * @see
	 * services.order.IOrderUpdateService#saveBatch(com.website.dto.order.Order
	 * [])
	 */
	@Override
	public String saveBatch(OrderBo[] orders) {
	 ...
	 * 
	 * @see
	 * services.order.IOrderUpdateService#updateTransactionId(java.lang.Integer,
	 * java.lang.String)
	 */
	// need recode
	@Override
	 ...
	 * 
	 * @see
	 * services.order.IOrderUpdateService#updateTransactionId(java.lang.String,
	 * java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * services.order.IOrderUpdateService#updatePaymentTime(java.lang.Integer)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * services.order.IOrderUpdateService#updatePaymentAccount(java.lang.Integer
	 * , java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * services.order.IOrderUpdateService#updateOrderPrice(java.lang.Integer,
	 * java.lang.Double)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * services.order.IOrderUpdateService#updateOrderShippingPrice(java.lang
	 * .Integer, java.lang.Double, java.lang.Double)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * services.order.IOrderUpdateService#updateOrderRemark(java.lang.Integer,
	 * java.lang.String)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * services.order.IOrderUpdateService#updateOrderAddress(java.lang.String,
	 * dto.member.MemberAddress)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * services.order.IOrderUpdateService#updateShippingMethod(dto.order.Order)
	 */
	@Override
	...
	public boolean replaceOrder(Integer orderId, Integer status,
		...
		int i = mapper.updatePaymentAndMessage(orderId, status, email,
				paymentId, null);
		if (1 == i) {
			return true;
		}
