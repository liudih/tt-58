 ...
 */
@Configuration
@MapperScan(basePackages = "com.tomtop.mappers.product", sqlSessionFactoryRef = "productSqlSessionFactory")
public class ProductMybatisConfig {
	...
	public DataSource dataSource() {
		...
		if (jdbcConnectionSettings.getProductMaxConnectionsPerPartition() != null) {
			ds.setMaxConnectionsPerPartition(jdbcConnectionSettings
					.getMaxConnectionsPerPartition());
		}
		if (jdbcConnectionSettings.getProductMinConnectionsPerPartition() != null) {
