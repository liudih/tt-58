 ...
 */
@Configuration
@MapperScan(basePackages = "com.tomtop.mappers.member", sqlSessionFactoryRef = "memberSqlSessionFactory")
public class MemberMybatisConfig {
	...
	public DataSource dataSource() {
		...
		ds.setDriverClass(jdbcConnectionSettings.getMemberDriver());
		...
		if (jdbcConnectionSettings.getMemberMaxConnectionsPerPartition() != null) {
			ds.setMaxConnectionsPerPartition(jdbcConnectionSettings
					.getMaxConnectionsPerPartition());
		}
		if (jdbcConnectionSettings.getMemberMinConnectionsPerPartition() != null) {
	...
	public SqlSessionFactory sqlSessionFactory(
			@Qualifier("member") DataSource datasource)
			throws Exception {
	...
	public void postConstruct() {
		log.debug("jdbc.settings={}", jdbcConnectionSettings);
	}
}
