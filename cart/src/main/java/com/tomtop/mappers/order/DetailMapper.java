...
public interface DetailMapper {
	...
	@Select("select * from t_order_detail where iorderid in(select iid from t_order where cordernumber='${orderNum}')")
	public List<OrderDetail> getOrderDetailsByOrderNum(@Param("orderNum") String orderNum);
}
