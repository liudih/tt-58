...
public class FreeShippingController {
	...
	@Autowired
	IFreeShippingService freeShippingService;
	 ...
	 *            价格范围过滤条件
	 */
	@RequestMapping(method = RequestMethod.GET, value = "/v1/product/freeshipping")
	public Result getProductNewArrivals(
		...
		//实现freeshipping接口
		ProductBaseSearchKeyword vo = freeShippingService.getProductFreeShipping(keyword, website, lang, currency, categoryId, page, size, sort, depotName, brand, yjPrice);
