...
public class FormatDateUtils {
	private static final Logger logger = LoggerFactory
			.getLogger(FormatDateUtils.class);
	...
	public FormatDateUtils() {
	}

	public FormatDateUtils(String pattern) {
	...
	public static void main(String[] args) {
		 try {
			 FormatDateUtils.getCurrentUtcTime();
			FormatDateUtils.getCurrentUtcTimeDate();
		} catch (ParseException e) {
			e.printStackTrace();
		}
	}
	 ...
	 * @return String
	 */
	public static String getCurrentUtcTimeYYYYMMDD() {         
		Date l_datetime = new Date();         
