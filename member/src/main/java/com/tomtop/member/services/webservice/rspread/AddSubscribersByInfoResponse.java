...
public class AddSubscribersByInfoResponse  implements java.io.Serializable {
    private AddSubscribersByInfoResponseAddSubscribersByInfoResult addSubscribersByInfoResult;

    public AddSubscribersByInfoResponse() {
    }

    public AddSubscribersByInfoResponse(
           AddSubscribersByInfoResponseAddSubscribersByInfoResult addSubscribersByInfoResult) {
     ...
     */
    public AddSubscribersByInfoResponseAddSubscribersByInfoResult getAddSubscribersByInfoResult() {
        return addSubscribersByInfoResult;
    }
     ...
     */
    public void setAddSubscribersByInfoResult(AddSubscribersByInfoResponseAddSubscribersByInfoResult addSubscribersByInfoResult) {
        this.addSubscribersByInfoResult = addSubscribersByInfoResult;
    }
