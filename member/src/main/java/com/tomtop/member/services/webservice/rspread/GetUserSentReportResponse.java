...
public class GetUserSentReportResponse  implements java.io.Serializable {
    private GetUserSentReportResponseGetUserSentReportResult getUserSentReportResult;

    public GetUserSentReportResponse() {
    }

    public GetUserSentReportResponse(
           GetUserSentReportResponseGetUserSentReportResult getUserSentReportResult) {
     ...
     */
    public GetUserSentReportResponseGetUserSentReportResult getGetUserSentReportResult() {
        return getUserSentReportResult;
    }
     ...
     */
    public void setGetUserSentReportResult(GetUserSentReportResponseGetUserSentReportResult getUserSentReportResult) {
        this.getUserSentReportResult = getUserSentReportResult;
    }
