...
public class GetCampaignBouncesResponse  implements java.io.Serializable {
    private GetCampaignBouncesResponseGetCampaignBouncesResult getCampaignBouncesResult;

    public GetCampaignBouncesResponse() {
    }

    public GetCampaignBouncesResponse(
           GetCampaignBouncesResponseGetCampaignBouncesResult getCampaignBouncesResult) {
     ...
     */
    public GetCampaignBouncesResponseGetCampaignBouncesResult getGetCampaignBouncesResult() {
        return getCampaignBouncesResult;
    }
     ...
     */
    public void setGetCampaignBouncesResult(GetCampaignBouncesResponseGetCampaignBouncesResult getCampaignBouncesResult) {
        this.getCampaignBouncesResult = getCampaignBouncesResult;
    }
