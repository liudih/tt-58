...
public class GetSubscriptionResponse  implements java.io.Serializable {
    private GetSubscriptionResponseGetSubscriptionResult getSubscriptionResult;

    public GetSubscriptionResponse() {
    }

    public GetSubscriptionResponse(
           GetSubscriptionResponseGetSubscriptionResult getSubscriptionResult) {
     ...
     */
    public GetSubscriptionResponseGetSubscriptionResult getGetSubscriptionResult() {
        return getSubscriptionResult;
    }
     ...
     */
    public void setGetSubscriptionResult(GetSubscriptionResponseGetSubscriptionResult getSubscriptionResult) {
        this.getSubscriptionResult = getSubscriptionResult;
    }
