...
public class GetSubscribersResponse  implements java.io.Serializable {
    private GetSubscribersResponseGetSubscribersResult getSubscribersResult;

    public GetSubscribersResponse() {
    }

    public GetSubscribersResponse(
           GetSubscribersResponseGetSubscribersResult getSubscribersResult) {
     ...
     */
    public GetSubscribersResponseGetSubscribersResult getGetSubscribersResult() {
        return getSubscribersResult;
    }
     ...
     */
    public void setGetSubscribersResult(GetSubscribersResponseGetSubscribersResult getSubscribersResult) {
        this.getSubscribersResult = getSubscribersResult;
    }
