...
public class GetAccountInfoResponse  implements java.io.Serializable {
    private GetAccountInfoResponseGetAccountInfoResult getAccountInfoResult;

    public GetAccountInfoResponse() {
    }

    public GetAccountInfoResponse(
           GetAccountInfoResponseGetAccountInfoResult getAccountInfoResult) {
     ...
     */
    public GetAccountInfoResponseGetAccountInfoResult getGetAccountInfoResult() {
        return getAccountInfoResult;
    }
     ...
     */
    public void setGetAccountInfoResult(GetAccountInfoResponseGetAccountInfoResult getAccountInfoResult) {
        this.getAccountInfoResult = getAccountInfoResult;
    }
