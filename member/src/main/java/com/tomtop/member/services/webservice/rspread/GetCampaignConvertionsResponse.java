...
public class GetCampaignConvertionsResponse  implements java.io.Serializable {
    private GetCampaignConvertionsResponseGetCampaignConvertionsResult getCampaignConvertionsResult;

    public GetCampaignConvertionsResponse() {
    }

    public GetCampaignConvertionsResponse(
           GetCampaignConvertionsResponseGetCampaignConvertionsResult getCampaignConvertionsResult) {
     ...
     */
    public GetCampaignConvertionsResponseGetCampaignConvertionsResult getGetCampaignConvertionsResult() {
        return getCampaignConvertionsResult;
    }
     ...
     */
    public void setGetCampaignConvertionsResult(GetCampaignConvertionsResponseGetCampaignConvertionsResult getCampaignConvertionsResult) {
        this.getCampaignConvertionsResult = getCampaignConvertionsResult;
    }
