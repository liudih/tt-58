...
public class GetCampaignAbusesResponse  implements java.io.Serializable {
    private GetCampaignAbusesResponseGetCampaignAbusesResult getCampaignAbusesResult;

    public GetCampaignAbusesResponse() {
    }

    public GetCampaignAbusesResponse(
           GetCampaignAbusesResponseGetCampaignAbusesResult getCampaignAbusesResult) {
     ...
     */
    public GetCampaignAbusesResponseGetCampaignAbusesResult getGetCampaignAbusesResult() {
        return getCampaignAbusesResult;
    }
     ...
     */
    public void setGetCampaignAbusesResult(GetCampaignAbusesResponseGetCampaignAbusesResult getCampaignAbusesResult) {
        this.getCampaignAbusesResult = getCampaignAbusesResult;
    }
