...
public class GetSubscriberDetailResponse  implements java.io.Serializable {
    private GetSubscriberDetailResponseGetSubscriberDetailResult getSubscriberDetailResult;

    public GetSubscriberDetailResponse() {
    }

    public GetSubscriberDetailResponse(
           GetSubscriberDetailResponseGetSubscriberDetailResult getSubscriberDetailResult) {
     ...
     */
    public GetSubscriberDetailResponseGetSubscriberDetailResult getGetSubscriberDetailResult() {
        return getSubscriberDetailResult;
    }
     ...
     */
    public void setGetSubscriberDetailResult(GetSubscriberDetailResponseGetSubscriberDetailResult getSubscriberDetailResult) {
        this.getSubscriberDetailResult = getSubscriberDetailResult;
    }
