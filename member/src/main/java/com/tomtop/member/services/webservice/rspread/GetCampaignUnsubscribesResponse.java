...
public class GetCampaignUnsubscribesResponse  implements java.io.Serializable {
    private GetCampaignUnsubscribesResponseGetCampaignUnsubscribesResult getCampaignUnsubscribesResult;

    public GetCampaignUnsubscribesResponse() {
    }

    public GetCampaignUnsubscribesResponse(
           GetCampaignUnsubscribesResponseGetCampaignUnsubscribesResult getCampaignUnsubscribesResult) {
     ...
     */
    public GetCampaignUnsubscribesResponseGetCampaignUnsubscribesResult getGetCampaignUnsubscribesResult() {
        return getCampaignUnsubscribesResult;
    }
     ...
     */
    public void setGetCampaignUnsubscribesResult(GetCampaignUnsubscribesResponseGetCampaignUnsubscribesResult getCampaignUnsubscribesResult) {
        this.getCampaignUnsubscribesResult = getCampaignUnsubscribesResult;
    }
