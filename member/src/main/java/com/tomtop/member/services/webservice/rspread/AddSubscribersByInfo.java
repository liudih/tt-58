...
public class AddSubscribersByInfo  implements java.io.Serializable {
    ...
    private Subscriber[] subscriberArgs;

    private java.lang.String subscription;

    private DoubleOptIn optInType;
     ...
     */
    public Subscriber[] getSubscriberArgs() {
        return subscriberArgs;
    }
     ...
     */
    public void setSubscriberArgs(Subscriber[] subscriberArgs) {
        this.subscriberArgs = subscriberArgs;
    }
     ...
     * @return optInType
     */
    public DoubleOptIn getOptInType() {
        return optInType;
    }
     ...
     * @param optInType
     */
    public void setOptInType(DoubleOptIn optInType) {
        this.optInType = optInType;
    }
