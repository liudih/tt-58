...
public class GetUserCreditResponse  implements java.io.Serializable {
    private GetUserCreditResponseGetUserCreditResult getUserCreditResult;

    public GetUserCreditResponse() {
    }

    public GetUserCreditResponse(
           GetUserCreditResponseGetUserCreditResult getUserCreditResult) {
     ...
     */
    public GetUserCreditResponseGetUserCreditResult getGetUserCreditResult() {
        return getUserCreditResult;
    }
     ...
     */
    public void setGetUserCreditResult(GetUserCreditResponseGetUserCreditResult getUserCreditResult) {
        this.getUserCreditResult = getUserCreditResult;
    }
