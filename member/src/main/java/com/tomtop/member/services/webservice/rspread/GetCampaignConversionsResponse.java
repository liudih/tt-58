...
public class GetCampaignConversionsResponse  implements java.io.Serializable {
    private GetCampaignConversionsResponseGetCampaignConversionsResult getCampaignConversionsResult;

    public GetCampaignConversionsResponse() {
    }

    public GetCampaignConversionsResponse(
           GetCampaignConversionsResponseGetCampaignConversionsResult getCampaignConversionsResult) {
     ...
     */
    public GetCampaignConversionsResponseGetCampaignConversionsResult getGetCampaignConversionsResult() {
        return getCampaignConversionsResult;
    }
     ...
     */
    public void setGetCampaignConversionsResult(GetCampaignConversionsResponseGetCampaignConversionsResult getCampaignConversionsResult) {
        this.getCampaignConversionsResult = getCampaignConversionsResult;
    }
