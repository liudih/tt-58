...
public class GetCampaignOpensResponse  implements java.io.Serializable {
    private GetCampaignOpensResponseGetCampaignOpensResult getCampaignOpensResult;

    public GetCampaignOpensResponse() {
    }

    public GetCampaignOpensResponse(
           GetCampaignOpensResponseGetCampaignOpensResult getCampaignOpensResult) {
     ...
     */
    public GetCampaignOpensResponseGetCampaignOpensResult getGetCampaignOpensResult() {
        return getCampaignOpensResult;
    }
     ...
     */
    public void setGetCampaignOpensResult(GetCampaignOpensResponseGetCampaignOpensResult getCampaignOpensResult) {
        this.getCampaignOpensResult = getCampaignOpensResult;
    }
