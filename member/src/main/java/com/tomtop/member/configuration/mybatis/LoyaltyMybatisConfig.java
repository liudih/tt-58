 ...
 */
@Configuration
@MapperScan(basePackages = "com.tomtop.member.mappers.loyalty", sqlSessionFactoryRef = "loyaltySqlSessionFactory")
public class LoyaltyMybatisConfig {
	...
	// @Bean(name = "loyaltySqlSessionTemplate")
	// public SqlSessionTemplate loyaltySqlSessionTemplate(
	// @Qualifier("loyaltySqlSessionFactory") SqlSessionFactory
	// sqlSessionFactory)
	// throws Exception {
