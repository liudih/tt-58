 ...
 */
@Configuration
@MapperScan(basePackages = "com.tomtop.member.mappers.message", sqlSessionFactoryRef = "messageSqlSessionFactory")
public class MessageMybatisConfig {

	private static Logger log = LoggerFactory
			.getLogger(MessageMybatisConfig.class);
	...
	public DataSource messageDataSource() {
		...
		ds.setUsername(jdbcConnectionSettings.getMessageUsername());
		ds.setPassword(jdbcConnectionSettings.getMessagePassword());
		ds.setJdbcUrl(jdbcConnectionSettings.getMessageUrl());
	...
	public SqlSessionFactory messageSqlSessionFactory(
		...
		sqlSessionFactory.setMapperLocations(getResource("mapper/message",
				"**/*.xml"));
	...
	// @Qualifier("messageSqlSessionFactory") SqlSessionFactory
	// sqlSessionFactory)
	// throws Exception {
