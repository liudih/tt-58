...
public class FindPasswordEmailModel {
	...
	public FindPasswordEmailModel(){
		
	}
	
	public FindPasswordEmailModel(String toemail,String url,String code,String emailType,Integer language){
