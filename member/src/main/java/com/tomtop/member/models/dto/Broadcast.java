...
public class Broadcast implements Serializable {
	...
	private MessageSendType sendMethodEnum;
	// 创建时间
	...
	public MessageSendType getSendMethodEnum() {
		return sendMethodEnum;
	}

	public void setSendMethodEnum(MessageSendType sendMethodEnum) {
	...
	public void setType(int type) {
		this.type = type;
		this.typeEnum = MessageType.getType(type);
	}
	...
	public void setSendMethod(int sendMethod) {
		...
		this.sendMethodEnum = MessageSendType.getSendMethod(sendMethod);
	}
