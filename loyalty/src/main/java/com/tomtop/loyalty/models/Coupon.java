...
public class Coupon implements Serializable {
	...
	public boolean isCash() {
		return PreferRuleEnum.RuleType.CASH.getCode() == this.getValueType();
	}
	...
	public String getValidStartDateStr() {
		return validStartDateStr;
	}
	public void setValidStartDateStr() {
		this.validStartDateStr = this.getValidStartDate(PATTERN);
	}
	...
	public void setValidEndDateStr() {
		this.validEndDateStr = this.getValidEndDate(PATTERN);
	}
