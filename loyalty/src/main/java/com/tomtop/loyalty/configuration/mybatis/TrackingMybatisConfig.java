 ...
 */
@Configuration
@MapperScan(basePackages = "com.tomtop.loyalty.mappers.tracking", sqlSessionFactoryRef = "trackingSqlSessionFactory")
public class TrackingMybatisConfig {
	...
	public SqlSessionFactory sqlSessionFactory(
		...
		sqlSessionFactory.setMapperLocations(getResource("mapper/tracking",
				"*.xml"));
