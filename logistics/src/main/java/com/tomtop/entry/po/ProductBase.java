...
public class ProductBase implements Serializable {
	...
	private double flength;				  //长
	private double fwidth;				  //高
	private double fheight;				  //高	
	private double fvolumeweight;		  //体积重
	...
	public double getFvolumeweight() {
		return fvolumeweight;
	}

	public void setFvolumeweight(double fvolumeweight) {
