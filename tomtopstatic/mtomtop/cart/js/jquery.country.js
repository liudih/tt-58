...
;(function($, document, undefined) {
	...
	Plugin.prototype = {
		...
		_createElements: function() {
			...
			ele.push('<input tag="countryCode" type="hidden" name="' + this.options.countryCodeInputName + '" />');
			ele.push('<input tag="countryId" type="hidden" name="' + this.options.countryIdInputName + '"  />');
